...
/**
 * Servlet implementation class ScopeTestCtrl(Arunjyoti)
 */
...
public class ScopeTestCtrl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// to set a value(Arunjyoti)
		request.setAttribute("REQUEST","Request Scope");
		//get session has access to doget and dopost method and set the value of session,request,application(Arunjyoti)
		...
		// returns a printwriter object that can send character text to the client here it is hello servlet(Arunjyoti)
